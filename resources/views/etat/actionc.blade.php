...
@section('titre', 'Fiche Action corrective')
        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                        ...
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <ul class="list-inline">
                                    ...
                                    <li>
                                        <a class="btn btn-icon btn-lg btn-white btn-dim btn-outline-primary" id="btn_download_actionc">
                ...
                <div class="nk-block mt-3 col-lg-8 ms-auto me-auto">
                    <div class="bg-white">
                        <div class=" row g-gs" id="cadre_actionc" style="margin-top: -30px; ">
...
<script src="{{asset('assets/js/app/print/actionc.js')}}"></script>
