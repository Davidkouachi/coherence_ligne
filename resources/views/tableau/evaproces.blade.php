...
@section('titre', 'Evaluation des processus')
    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content" style="margin:0px auto;">
                            <h3 class="text-center">
                                <span>Tableau d'evaluation des processus</span>
                ...
                @endphp
                @for ($i = 1; $i <= $maxValue; $i++) @php $isInInterval=false; @endphp @foreach($color_intervals as $color_interval) @if ($i>= $color_interval->nbre1 && $i <= $color_interval->nbre2)
                        @php
                            $isInInterval = true;
                                                                        ...
                                                                        <div class="drodown"><a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li>
                                                                                        <a data-bs-toggle="modal" data-bs-target="#modalDetail{{$processu->id}}" href="#">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group text-center">
                                                ...
                                                <div class="form-control-wrap">
                                                    ...
                                                    @foreach($color_intervals as $color_interval)
                                                    @if($color_interval->nbre1 <= $processu->evag && $color_interval->nbre2 >= $processu->evag)
                                                        <input value="{{ $processu->evag }}" disabled type="text" class="form-control border-white text-center " id="Cause" style="background-color:{{$color_interval->code_color}}">
                                                        @php
                                                        ...
                                                        @endforeach
                                                        @if(!$colorMatchFound0)
                                                        <input value="{{ $processu->evag }}" disabled type="text" class="form-control border-white text-center " id="Cause" style="background-color:#8e8e8e;">
                                                        @endif
                                                </div>
                                            </div>
                                        </div>
