...
<ul class="nk-sticky-toolbar"  >
    <li class="demo-thumb" >
        <a data-type="Couleur" class="toggle tipinfo " aria-label="Afficher les Couleurs" data-bs-original-title="Couleurs" data-bs-toggle="modal" data-bs-target="#modalColor">
...
<div class="modal fade zoom" tabindex="-1" id="modalColor">
    <div class="modal-dialog modal-sm" role="document" style="width: 75%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Intervals des Couleurs</h5>
