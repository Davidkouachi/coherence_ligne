...
Route::middleware(['role:admin'])->group(function () {
    Route::get('/Panel', [PanelController::class, 'index_panel'])->name('index_panel');
    // ---------------------------------------
    Route::get('/Nouvelle entreprise', [PanelController::class, 'index_add_entreprise'])->name('index_add_entreprise');
    Route::get('/Liste des entreprises', [PanelController::class, 'index_list_entreprise'])->name('index_list_entreprise');
    Route::get('/Type d\'entreprise', [PanelController::class, 'index_type_entreprise'])->name('index_type_entreprise');
    Route::post('/add_type', [EntrepriseController::class, 'add_type'])->name('add_type');
    Route::post('/update_type', [EntrepriseController::class, 'update_type'])->name('update_type');
    Route::get('/Secteur d\'activité', [PanelController::class, 'index_secteur_entreprise'])->name('index_secteur_entreprise');
    Route::post('/add_secteur', [EntrepriseController::class, 'add_secteur'])->name('add_secteur');
    Route::post('/update_secteur', [EntrepriseController::class, 'update_secteur'])->name('update_secteur');
    // ---------------------------------------
    Route::get('/Type de plan d\'abonnement', [PanelController::class, 'index_type_plan'])->name('index_type_plan');
    Route::post('/add_type_plan', [AbonnementController::class, 'add_type_plan'])->name('add_type_plan');
    Route::post('/update_type_plan', [AbonnementController::class, 'update_type_plan'])->name('update_type_plan');
});
...
// Route pour les deux rôles
Route::middleware(['role:admin', 'role:user'])->group(function () {
