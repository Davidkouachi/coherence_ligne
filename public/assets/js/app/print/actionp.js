window.onload = function() {
    document.getElementById('btn_download_actionp').addEventListener('click', function() {
        // Sélection du formulaire à imprimer
        const form = document.getElementById('cadre_actionp');

        // Configuration pour la génération PDF
        const opt = {
            margin: 10,
            filename: 'Fiche Action Préventive.pdf',
